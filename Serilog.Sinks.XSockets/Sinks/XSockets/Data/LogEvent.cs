...
namespace Serilog.Sinks.XSockets.Sinks.XSockets.Data
{
    ...
    {
        /// <summary>
        /// Construct a new <see cref="LogEventWrapper"/>.
        /// </summary>
        ...
        /// Construct a new <see cref="LogEventWrapper"/>.
        /// </summary>
        public LogEventWrapper(LogEvent logEvent, string renderedMessage)
        {
            ...
            {
                Properties.Add(pair.Key, XSocketsPropertyFormatter.Simplify(pair.Value));
            }
        }
