...
namespace Serilog.Sinks.SystemConsole
{
    class ColoredConsoleSink : ILogEventSink
    {
        ...
        void RenderExceptionToken(Palette palette, MessageTemplateToken outputToken, IDictionary<string, LogEventPropertyValue> outputProperties, TextWriter output)
        {
        ...
        void RenderOutputToken(Palette palette, MessageTemplateToken outputToken, IDictionary<string, LogEventPropertyValue> outputProperties, TextWriter output)
        {
            SetBaseColors(palette);
