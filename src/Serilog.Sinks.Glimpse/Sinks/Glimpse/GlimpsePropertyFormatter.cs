...
namespace Serilog.Sinks.Glimpse
{
    ...
    /// that render well in Glimpse.
    /// </summary>
    static class GlimpsePropertyFormatter
    {
        static readonly HashSet<Type> GlimpseScalars = new HashSet<Type>
        {
            typeof(bool),
        ...
        static object SimplifyScalar(object value)
        {
            ...
            if (GlimpseScalars.Contains(valueType)) return value;
