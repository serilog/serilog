...
namespace Serilog.Configuration
{
    ...
    public class LoggerSinkConfiguration
    {
        ...
        /// events passed through the sink.</param>
        /// <returns>Configuration object allowing method chaining.</returns>
        public LoggerConfiguration ThresholdLogger(int bufferSize,
           ...
           LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum)
        {
            ...
            var lc = new LoggerConfiguration();
            configureLogger(lc);
            return Sink(new BufferedSink(bufferSize, threshHoldLevel,(ILogEventSink)lc.CreateLogger()), restrictedToMinimumLevel);
        }
