...
namespace Serilog
{
    ...
    public interface ILogger
    {
        ...
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T>(LogEventLevel level, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T0, T1>(LogEventLevel level, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T0, T1, T2>(LogEventLevel level, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        /// <param name="propertyValue">Object positionally formatted into the message template.</param>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T>(LogEventLevel level, Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        /// <param name="propertyValue1">Object positionally formatted into the message template.</param>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T0, T1>(LogEventLevel level, Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        /// <param name="propertyValue2">Object positionally formatted into the message template.</param>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Write<T0, T1, T2>(LogEventLevel level, Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        {
            // Avoid the array allocation and any boxing allocations when the level isn't enabled
            if (IsEnabled(level))
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Verbose<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Debug<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Information<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Warning<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Error<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T>(string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T0, T1>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T0, T1, T2>(string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T>(Exception? exception, string messageTemplate, [AllowNull] T propertyValue)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T0, T1>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1)
#if FEATURE_DEFAULT_INTERFACE
        ...
        /// </example>
        [MessageTemplateFormatMethod("messageTemplate")]
        void Fatal<T0, T1, T2>(Exception? exception, string messageTemplate, [AllowNull] T0 propertyValue0, [AllowNull] T1 propertyValue1, [AllowNull] T2 propertyValue2)
#if FEATURE_DEFAULT_INTERFACE
