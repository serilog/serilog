...
namespace Serilog.Events
{
    ...
    {
        private readonly IDictionary<ScalarValue, LogEventPropertyValue> _elements;
        ...
        /// </summary>
        public IDictionary<ScalarValue, LogEventPropertyValue> Elements { get { return _elements; } }
        ...
        protected override void RenderCore(TextWriter output, string format = null, IFormatProvider formatProvider = null)
        {
            ...
            foreach (var kvp in _elements)
            {
                output.Write(delim);
                delim = ", (";
                kvp.Key.Render(output, null, 0, formatProvider);
                output.Write(": ");
                kvp.Value.Render(output, null, 0, formatProvider);
                output.Write(")");
            }
