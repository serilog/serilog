...
namespace Serilog
{
    ...
    public static class LoggerConfigurationMongoDBExtensions
    {
        ...
        public static LoggerConfiguration MongoDB(this LoggerSinkConfiguration loggerConfiguration, string databaseUrl, LogEventLevel restrictedToMinimumLevel = LogEventLevel.Minimum)
        {
            if (loggerConfiguration == null) throw new ArgumentNullException("loggerConfiguration");
            if (databaseUrl == null) throw new ArgumentNullException("databaseUrl");
            return loggerConfiguration.Sink(new MongoDBSink(databaseUrl), restrictedToMinimumLevel);
        }
    }
}
