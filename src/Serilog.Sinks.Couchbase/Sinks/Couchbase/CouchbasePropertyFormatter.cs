...
namespace Serilog.Sinks.Couchbase
{
    ...
    /// dictionaries and lists so that they can be persisted in Couchbase.
    /// </summary>
    public static class CouchbasePropertyFormatter
    {
        static readonly HashSet<Type> CouchbaseSpecialScalars = new HashSet<Type>
        {
            typeof(bool),
        ...
        static object SimplifyScalar(object value)
        {
            ...
            if (CouchbaseSpecialScalars.Contains(valueType)) return value;
