...
namespace Serilog.Sinks.Couchbase.Data
{
    /// <summary>
    /// A wrapper class for <see cref="Events.LogEvent"/> that is used to store as a document in Couchbase
    /// </summary>
    public class LogEvent
    {
        ...
        public LogEvent(Events.LogEvent logEvent, string renderedMessage)
        {
            ...
            {
                Properties.Add(pair.Key, CouchbasePropertyFormatter.Simplify(pair.Value));
            }
        }
