...
namespace Serilog.Sinks.EventStore
{
    ...
    /// dictionaries and lists so that they can be persisted in the EventStore.
    /// </summary>
    public static class EventStorePropertyFormatter
    {
        static readonly HashSet<Type> EventStoreSpecialScalars = new HashSet<Type>
        {
            typeof(bool),
        ...
        static object SimplifyScalar(object value)
        {
            ...
            if (EventStoreSpecialScalars.Contains(valueType)) return value;
