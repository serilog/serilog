...
public class MessageTemplateTests
{
    ...
    static string Render(IFormatProvider? formatProvider, string messageTemplate, params object[] properties)
    {
        ...
        var binder = new PropertyBinder(new PropertyValueConverter(10, 1000, 1000, Enumerable.Empty<Type>(), Enumerable.Empty<Type>(), Enumerable.Empty<IDestructuringPolicy>(), Enumerable.Empty<ITypeDestructuringPolicy>(), false));
