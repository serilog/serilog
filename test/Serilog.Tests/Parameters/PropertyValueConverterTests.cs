...
namespace Serilog.Tests.Parameters
{
    ...
    {
        readonly PropertyValueConverter _converter = new PropertyValueConverter(Enumerable.Empty<Type>(), Enumerable.Empty<IDestructuringPolicy>(), Enumerable.Empty<ILogPropertyFilter>());
